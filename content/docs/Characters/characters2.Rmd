...
*(The x axis is meaningful and accurately represents the year of the case. The y axis is just a fairly meaningless way of spreading out the data points - I assigned counts when multiple cases appearing per year, so the higher dots just represent that there's multiple cases in a year, nothing else. I added jitter (height randomizer) just to spread the points out even more.)*
...
Most of the couples appear on the same side of the litigation, operating essentially as a unit. Interestingly, most of 
