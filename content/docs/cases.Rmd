...
cases_over_time <- contracts %>%
  ...
  ungroup %>%
  ggplot() +
  geom_jitter(width = 0, height = 0.3, col = "red2", aes(as.integer(year),forplot,alpha=0.05,text = paste(sep = "",simplecite,", ",year))) +
  labs(title = "All Cases in KCP, Duplicate Years Spread over Y Axis", x = "Year", y = "Cases")
