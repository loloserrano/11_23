...
As someone who (full disclosure) went to BU and worked for a time at the HGARC, I have a lot of love for that institution and its impressive stacks (shout out to Ryan Hendrickson). The court easily finds that MLK's manifested intent in a letter was enforceable and BU has a legal right to the papers, which under contract theories of consideration is quite valid. 

However, might there be something said for the conditionality of that entrustment? Could the broader social circumstances in which MLK chose BU and wrote that letter be relevant to an assessment of legal rights? Again, there's no clear right answer, but failing to address (and actively underplaying, with the word "volatility") racial terrorism is a major issue. 
...
Maute's article also references work by KCP's Charles Knapp, calls KCP "a leading contracts textbook," and says on the first page that "The Author gratefully acknowledges comments on earlier drafts from Douglas Baird, Bill Whitford, **Chuck Knapp, and H.G. Prince.** So I don't think this is evidence that KCP were exactly scouring law reviews for interesting points about racial justice. 
