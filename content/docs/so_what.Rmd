...
The book and syllabi based on it would benefit from more references to secondary scholarship. The notes after [Locke v. Warner Bros.](/docs/characters/characters4) are a good example of exploring gendered and racial biases and the legal strategies that could be used to combat them. 
...
1. The prevalence of [widows](/docs/characters/characters3) is a very interesting quirk of the book. Husbandless women appear multiple times as vulnerable characters. They prompt some of the most emotionally charged opinions in the book, and potentially some thought-provoking conversations. Unmarried women, especially in the 19th and 20th centuries, did have particular vulnerabilities that made them good subjects for morally weighty opinions on unconscionability and good faith. The paternalism prompted by their vulnerability behooves their individuals outcomes (except in Kirksey). But in a larger sense, does it harm more than it helps? Does it reinforce gender stereotypes? Or is this a good example of courts intervening in marginalization, which they fail to do in P.M. v. T.B or King v. Trustees of Boston University? 

2. The massive proportion of [married women](/docs/characters/characters2) also deserves some attention. This could prompt conversations about barriers to entry in the legal system. Married women were not legally allowed to enter into contracts at all for much of Anglo and American history: are their rights still subsumed by their husbands? This is explored in the historical development of capacity note, but as I recommend above, could be given a more central place. The disproportionately challenges KCP's statement that "this legal disability was removed by the passage of the Married Women's Property Acts:" while true de jure, the historical issue seems to have long-ranging de facto consequences. 

I won't go so far as to make the other major finding a recommendation: the issue of potential corporate masculinity seems to be relatively unexplored in general. Mentioning it to law students might prompt some interest in the subject and future study, which I personally think would be interesting. But it's less important than the above points. 
